...
const cfg = templateConfigs.executive;
...
export function ExecutivePdfDocument({ data }: { data: ResumeData }) {
  ...
  const styles = StyleSheet.create({
    ...
    header: { marginBottom: cfg.spacingPt.sectionGap, textAlign: "center" },
    name: {
    ...
    heading: {
      ...
      letterSpacing: cfg.headingStyle === "uppercase" ? 0.75 : undefined,
      marginBottom: cfg.spacingPt.itemGap / 2,
      marginTop: cfg.spacingPt.sectionGap,
      ...(cfg.showAccentRule
        ? { borderBottomWidth: 1, borderBottomColor: accentHex, paddingBottom: 3 }
        : {}),
    },
