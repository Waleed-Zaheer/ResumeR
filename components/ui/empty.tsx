...
/**
 * Empty — a placeholder layout for empty states (no results, no
 * data yet), with optional icon/media, title, description, and
 * content slots (e.g. for a call-to-action button).
 *
 * Usage:
 *   <Empty>
 *     <EmptyHeader>
