...
/**
 * NativeSelect — a styled wrapper around the browser's native
 * `<select>` (full native keyboard/accessibility/mobile-picker
 * behavior for free, unlike a custom-built listbox).
 *
 * Usage:
