...
/**
 * Item — a generic list-row layout (media/icon + title/description +
 * trailing actions), the building block for things like settings rows,
 * file lists, or search results.
 *
 * Usage:
 *   <ItemGroup>
 *     <Item>
 ...
 *       </ItemContent>
 *       <ItemActions><Button size="icon-sm">...</Button></ItemActions>
 *     </Item>
 *   </ItemGroup>
 *
 * Depends on:
 *   - src/lib/utils.ts (cn helper)
 *   - src/lib/primitives/use-render.ts, merge-props.ts (the `render` prop, ref merging - Item only)
 *   - src/components/ui/separator.tsx (ItemSeparator)
 */
