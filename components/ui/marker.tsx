...
/**
 * Marker — a small labeled row, typically used as a timeline/list
 * bullet-point (with an optional separator or bottom-border variant).
 *
 * Usage:
 ...
 *   - src/lib/primitives/use-render.ts, merge-props.ts (the `render` prop, ref merging - Marker only)
 */
