...
/**
 * InputGroup — wraps an `<input>`/`<textarea>` with leading/trailing
 * addons (icons, buttons, text) inside one bordered, focus-ring-aware
 * container, so the whole group looks and focuses like a single field.
 *
 * Usage:
 *   <InputGroup>
 ...
 *   - src/components/ui/button.tsx (InputGroupButton)
 *   - src/components/ui/input.tsx (InputGroupInput)
 *   - src/components/ui/textarea.tsx (InputGroupTextarea)
 */
