...
/**
 * Message — layout primitives for a chat-style message list: a
 * left/right-aligned row with an avatar slot, content column, and
 * optional header/footer (e.g. sender name, timestamp).
 *
 * Usage:
 *   <MessageGroup>
 *     <Message align="end">
