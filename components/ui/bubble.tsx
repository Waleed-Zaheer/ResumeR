...
/**
 * Bubble — a chat message bubble (the rounded speech-bubble shape around
 ...
 *   - src/lib/primitives/use-render.ts, merge-props.ts (the `render` prop, ref merging - BubbleContent only)
 */
