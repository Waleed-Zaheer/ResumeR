...
/**
 * Attachment — a card showing an uploaded/attached file, with an
 * optional media preview, title/description, and hover actions. Also
 * doubles as a drop-zone trigger (AttachmentTrigger covers the whole
 * card) when state="idle".
 *
 * Usage:
 ...
 *   - src/lib/primitives/use-render.ts, merge-props.ts (the `render` prop, ref merging - AttachmentTrigger only)
 *   - src/components/ui/button.tsx (AttachmentAction is a styled Button)
 */
